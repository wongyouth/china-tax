  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tax as @tax" do
        ...
        post :create, {:tax => { "company_yanglao" => "invalid value" }}, valid_session
        assigns(:tax).should be_a_new(Tax)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tax" do
        ...
        Tax.any_instance.should_receive(:update_attributes).with({ "company_yanglao" => "1.5" })
        put :update, {:id => tax.to_param, :tax => { "company_yanglao" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tax as @tax" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tax.any_instance.stub(:save).and_return(false)
        put :update, {:id => tax.to_param, :tax => { "company_yanglao" => "invalid value" }}, valid_session
        assigns(:tax).should eq(tax)
      end
